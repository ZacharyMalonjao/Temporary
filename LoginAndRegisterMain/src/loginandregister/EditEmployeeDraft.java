...
public class EditEmployeeDraft extends javax.swing.JFrame {
 private EmployeeCSVReader reader;
 private List<String[]> employeeDataBase;
 private String[] employeeData;
    /**
     * Creates new form EditEmployeeDraft
     */
 //Validation Methods
 ...
 //Philhealth    
   ...
   //phonenumber  
    ...
    public EditEmployeeDraft(UserAccount userAcc) {
        initComponents();
...
//            java.util.logging.Logger.getLogger(EditEmployeeDraft.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new EditEmployeeDraft().setVisible(true);
//            }
//        });
//    }
